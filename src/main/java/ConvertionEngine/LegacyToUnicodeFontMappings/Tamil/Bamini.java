...
//        text = text.replaceAll("\\/", "ஃ");				// Visible as /


        text = text.replaceAll("h;","ர்");
        text = text.replaceAll("H", "ர்");				//@Gayan don't know why but doesn't get replaced.
        text = text.replaceAll("sp", "ளி");

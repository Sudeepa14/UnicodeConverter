        ...
        while (currentParagraphPosition<paragraphsCount){
            ...
            if (runs != null) {
                ...
                while (i < runsLength) {
                    ...
                    String text = convertedText[0];
//                    for (String nonStartable: nonStartables ) {
//                        if(text!= null && text.startsWith(nonStartable)){
//                            run.setText(text.substring(1),0);
//                            System.out.println(text.substring(1)+ " : "+run.getText(0)+nonStartable);
//                            if(i>0){
...
//                        }
//                    }
//                    for (String nonStartable: nonStartables ) {                     // Checking twice for better filtering
//                        if(text!= null && text.startsWith(nonStartable)){
//                            run.setText(text.substring(1),0);
//                            System.out.println(text.substring(1)+ " : "+run.getText(0)+nonStartable);
//
